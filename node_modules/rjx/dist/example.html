...
<html lang="en">
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      const dynamicClassComponent = rjx._rjxComponents.getReactClassComponent({ 
        render:{
          body:{
      ...
      const textContext = rjx._rjxComponents.getReactContext({
        value:{
          user:{ name:'john smith', activated: true, },
          settings: { use_offline: true, },
        },
      });
      const dynamicFunctionComponent = rjx._rjxComponents.getReactFunctionComponent(
        { 
